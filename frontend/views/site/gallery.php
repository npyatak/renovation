...
<div class="gallery">
	...
	<div class="container_inner">
		...
		<h1>Социальные обязательства: детские площадки, садики, школы и поликлиники</h1>
	</div>
	<div class="grid_wrap">
		<div class="grid">
			<div class="grid_item">
				...
				<div class="slider_gallery_wrap">
					...
					<div class="slider_gallery owl-carousel">
						<div class="slider_gallery_item owl-item ">
							<div class="text">
								<a href="#">Дома, построенные для переселения жильцов пятиэтажек в рамках программы реновации</a>
							</div>
						</div>
						<div class="slider_gallery_item owl-item ">
							<div class="text">
